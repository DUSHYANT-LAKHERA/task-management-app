                ...
                <div className='table-container'>
                    <table>
                        ...
                        {tasks.map((i, id) => <tr>
                            ...
                            <td onClick={() => navigate("/UpdateTask/" + i._id + "/?view-only=true")} className='onclick-pointer'>View</td>
                            <td>{i.priority}</td>
                            <td onClick={() => navigate("/UpdateTask/" + i._id)} className='onclick-pointer'>Edit</td>
                            <td onClick={() => handleDelete(i._id)} className='onclick-pointer'>Delete</td>
                        </tr>)}
                        {!(tasks?.length > 0) && <tr>
